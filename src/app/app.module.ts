...
import { ItemsService, WidgetsService, GizmoService, HomusService } from './shared';
...
import { BooyahComponent } from './booyah/booyah.component';
...
@NgModule({
  ...
  providers: [ItemsService, WidgetsService, GizmoService, HomusService],
